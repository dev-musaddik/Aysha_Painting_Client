...
const CartItem = ({ item }) => {
  ...
  return (
    <div className="flex flex-col sm:flex-row gap-4 p-4 bg-white rounded-lg shadow-md hover:shadow-lg transition">
      {/* Image */}
      ...
      <div className="flex-1">
        ...
        <div className="flex flex-wrap gap-2 text-sm text-gray-700 mb-3">
          ...
          {item.color && (
            <span className="px-2 py-1 bg-gray-100 rounded">Color: {item.color}</span>
          )}
          {item.material && (
            <span className="px-2 py-1 bg-gray-100 rounded">Material: {item.material}</span>
          )}
