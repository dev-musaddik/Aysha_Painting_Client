      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">
            Order ID: <span className="font-mono font-semibold">{order._id.slice(-8).toUpperCase()}</span>
          </p>
                ...
                {statusSteps.map((step, index) => (
                  <div key={step.key} className="flex flex-col items-center">
                    <div
                      ...
                      } ${step.active ? 'ring-4 ring-primary-200' : ''}`}
                    >
                      {step.icon}
                    </div>
                    <p
        ...
        <div className="bg-primary-50 rounded-xl p-6 text-center">
          ...
          <div className="flex justify-center space-x-4">
            <a
              ...
              className="inline-flex items-center px-4 py-2 bg-white border border-gray-300 rounded-lg hover:bg-gray-50 transition"
            >
